...
use BladeUI\CssggIcons\BladeCssggIconsServiceProvider;
...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('gg-globe', 'w-6 h-6 text-gray-500')->toHtml();
    ...
    {
        $result = svg('gg-globe', ['style' => 'color: #555'])->toHtml();
    ...
    protected function getPackageProviders($app)
    {
        return [
            ...
            BladeCssggIconsServiceProvider::class,
        ];
    }
}
